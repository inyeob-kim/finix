...
def build_system_prompt() -> str:
    return (
        ...
        "Prefer Korean titles/descriptions (English OK when source is English-only) so a business "
        "user understands each case from the list view without opening YAML.\n"
